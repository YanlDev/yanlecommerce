...
<div class="card">
    <form wire:submit="store">
        ...
        <div class="mb-4">
            ...
            {{--        <div--}}
            {{--            class="border-2 border-dashed border-slate-700 rounded-lg p-3 bg-slate-900 flex justify-center items-center w-full">--}}
            {{--            <figure class="w-full relative">--}}
            {{--                @if($image && $image instanceof TemporaryUploadedFile)--}}
            {{--                    <img src="{{ $image->temporaryUrl() }}" alt="Vista previa del producto">--}}
            {{--                @else--}}
            {{--                    <img--}}
            {{--                        src="{{ asset('img/no-image.png') }}"--}}
            {{--                        alt="imagen del producto"--}}
            {{--                        class="w-32 h-auto object-contain mx-auto"--}}
            {{--                    >--}}
            {{--                @endif--}}


            {{--                <label for="product-image"--}}
            {{--                       class="flex justify-end items-center p-2 cursor-pointer absolute top-1 right-0 bg-white rounded hover:bg-gray-100 transition-colors">--}}
            {{--                    <input--}}
            {{--                        wire:model="image"--}}
            {{--                        type="file"--}}
            {{--                        id="product-image"--}}
            ...
            {{--                    <span class="ml-2">Sube una imagen</span>--}}
            {{--                </label>--}}
            {{--            </figure>--}}
            {{--        </div>--}}
            <div
